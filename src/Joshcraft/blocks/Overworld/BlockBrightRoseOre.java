...
public class BlockBrightRoseOre extends Block{

	

	public BlockBrightRoseOre(int id, Material material) {
		super(id, material);
		
	}
	public int idDropped(int par1, Random random, int par3){
		return ItemHandler.BrightRoseGem.itemID;
	}
    ...
    {
            this.blockIcon = ir.registerIcon(ModInfo.ID + ":" + "brightroseore");
